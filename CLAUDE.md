...
- GET /api/incentive-plan-definitions · /summary - 시상정의 카탈로그(원수사가 준 정의 원형, 무손실 16열). ?insurerId·?month·?q·?category(4대 대분류 파생 필터 sengbo_fc/sengbo_corp/sonbo, F-056)+페이지. incentive_rules(정산엔진)와 분리, 정의는 참조/후보 (F-044/F-056)
