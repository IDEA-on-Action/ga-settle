...
- GET /api/incentive-plan-definitions · /summary - 시상정의 카탈로그(원수사가 준 정의 원형, 무손실 16열). ?insurerId·?month·?q·?category(대분류 필터 F-056/057/058: 생보 파생, 손보설계사/자체=OCR 링크 우선+xlsx 시상유형 소급, 규칙 문서 docs/reference/sonbo-시상유형-대분류-매핑.md)+페이지. incentive_rules(정산엔진)와 분리, 정의는 참조/후보 (F-044/F-056/F-057/F-058)
