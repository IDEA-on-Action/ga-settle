...
beforeEach(async () => {
  ...
  await db.insert(commissionRecords).values([
    { id: "cr1", uploadId: "up1", rowNo: 1, settlementMonth: "2026-06", insurerId: "ins1", contractNo: "C1", agentId: "ag1", premiumEnc: "100000" },
    { id: "cr2", uploadId: "up1", rowNo: 2, settlementMonth: "2026-06", insurerId: "ins1", contractNo: "C2", agentId: "ag1", premiumEnc: "100000" },
    { id: "cr3", uploadId: "up1", rowNo: 3, settlementMonth: "2026-06", insurerId: "ins1", contractNo: "C3", agentId: "ag2", premiumEnc: "200000" },
  ]);
